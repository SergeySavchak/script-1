...
drop index idx_city;
drop index idx_city_1;
drop index idx_city_2;
drop index idx_city_3;
drop index idx_city_4;


create index idx_surname on metrics(surname); 
create index idx_firname on metrics(firname); 
create index idx_city_id on metrics(city_id); 
create index idx_date on metrics(metrics_insdt); 

create index idx_surname_1 on metrics_1(surname); 
create index idx_firname_1 on metrics_1(firname); 
create index idx_city_id_1 on metrics_1(city_id); 
create index idx_date_1 on metrics_1(metrics_insdt); 

create index idx_surname_2 on metrics_2(surname); 
create index idx_firname_2 on metrics_2(firname); 
create index idx_city_id_2 on metrics_2(city_id); 
create index idx_date_2 on metrics_2(metrics_insdt); 

create index idx_surname_3 on metrics_3(surname); 
create index idx_firname_3 on metrics_3(firname); 
create index idx_city_id_3 on metrics_3(city_id); 
create index idx_date_3 on metrics_3(metrics_insdt); 

create index idx_surname_4 on metrics_4(surname); 
create index idx_firname_4 on metrics_4(firname); 
create index idx_city_id_4 on metrics_4(city_id); 
create index idx_date_4 on metrics_4(metrics_insdt); 

drop index idx_surname;
drop index idx_firname;
drop index idx_city_id;
drop index idx_date;

drop index idx_surname_1;
drop index idx_firname_1;
drop index idx_city_id_1;
drop index idx_date_1;

drop index idx_surname_2;
drop index idx_firname_2;
drop index idx_city_id_2;
drop index idx_date_2;

drop index idx_surname_3;
drop index idx_firname_3;
drop index idx_city_id_3;
drop index idx_date_3;

drop index idx_surname_4;
drop index idx_firname_4;
drop index idx_city_id_4;
drop index idx_date_4;
...
-- частые значения и частота их встречаемости most_common_vals и most_common_freqs

gin индекс для json/bjson
...
select attname, n_distinct, null_frac, most_common_vals, most_common_freqs, correlation, histogram_bounds from pg_stats where tablename = 'metrics_1_hash_1_2022_01';


select round((extract(epoch from date_trunc('month', '2022/03/23'::timestamp)) - extract(epoch from date_trunc('month','2022/01/01'::timestamp)))::numeric / 60 / 60 / 24 , 0)
